...
export default class Feed extends Component{
    ...
    registerToSocket = () =>{
        const socket = io('http://192.168.25.48:8888');
    ...
    render(){
        return (
            <View style={styles.container}>
                ...
                keyExtractor={post => post._id}// chave unica
                renderItem={({item}) => (
                    <View style={styles.feedItem}>
                        ...
                        <Image style={styles.feedImage} source={{uri: `http://192.168.25.48:8888/files/${item.image}`}}/>
